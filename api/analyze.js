...
// The system instruction + response schema are moved here VERBATIM from the
// previous client-side services/geminiService.ts implementation. Behaviour
// (model, temperature, schema, output shape) is intentionally identical.
